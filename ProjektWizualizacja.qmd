...
Problem samobójstw pozostaje jednym z najpoważniejszych wyzwań społecznych i zdrowotnych na całym świecie. Zrozumienie wpływu czynników, takich jak rozwój gospodarczy, poziom życia czy struktura demograficzna, jest kluczowe dla identyfikacji grup szczególnie narażonych. Celem projektu jest zbadanie zależności między wskaźnikami samobójstw a różnorodnymi czynnikami demograficznymi, takimi jak wiek, płeć i przynależność do określonej generacji, oraz gospodarczymi, w tym PKB per capita i poziomem rozwoju społecznego (HDI). Analiza obejmuje różne kraje i okresy, a jej wyniki mogą zostać wykorzystane do opracowywania polityk prewencyjnych, wsparcia psychologicznego oraz działań edukacyjnych w różnych regionach.

W ramach badania postawiono kluczowe pytania: czy płeć, wiek i generacja wpływają na liczbę samobójstw? Jakie kraje charakteryzują się najwyższymi, a jakie najniższymi wskaźnikami samobójstw, i czy te różnice można powiązać z poziomem rozwoju społeczno-ekonomicznego? Jak zmieniały się wskaźniki samobójstw na przestrzeni lat w zależności od regionu geograficznego?

Postawiono również hipotezy. Zakłada się, że mężczyźni mają wyższe wskaźniki samobójstw niż kobiety, zwłaszcza w młodszych grupach wiekowych. Przewiduje się również, że kraje o niższym poziomie rozwoju społecznego i gospodarczego, mierzonego za pomocą HDI i PKB per capita, cechują się wyższymi wskaźnikami samobójstw. Dodatkowo zakłada się, że starsze generacje, takie jak „Silent Generation” czy „G.I. Generation”, są bardziej narażone na samobójstwa niż młodsze grupy, takie jak „Millennials” czy „Generation Z”.
...
4.  Konwersja zmiennych tekstowych

5.  Usunięcie roku 2016.

6.  Zamiana niektórych nazw państw.
...
plot_ly(sex_summary, 
  ...
  layout(title = "Średnia liczba samobójstw na 100k ludności według płci")
```

## Wpływ wieku na statystyki samobójstw

W latach 1985-2015 najwyższy wskaźnik samobójstw odnotowano w grupie wiekowej 75+, która odpowiada za 29,3% wszystkich przypadków. Może to być związane z problemami charakterystycznymi dla zaawansowanego wieku, takimi jak samotność, choroby przewlekłe czy brak wsparcia społecznego.
...
Analiza wykresów pokazuje, że najwyższe wskaźniki samobójstw występowały wśród G.I. Generation (23,99) i Silent Generation (19,32), szczególnie w grupach wiekowych 75+ lat. Najniższe wartości odnotowano wśród Generation Z, co wynika z młodego wieku tej grupy. Mężczyźni mają znacznie wyższe wskaźniki samobójstw niż kobiety we wszystkich generacjach, zwłaszcza w starszych. Samobójstwa są też bardziej powszechne w starszych generacjach i wśród mężczyzn, a młodsze pokolenia charakteryzują się niższymi wskaźnikami z uwagi na krótszy czas obserwacji.
...
Największą liczbę samobójstw odnotowano w Europie Wschodniej, szczególnie w krajach byłego ZSRR, oraz w niektórych krajach Ameryki Południowej i Północnej.
...
Dane ujawniają, że najwyższy wskaźnik samobójstw występuje w grupie wiekowej 75+ lat, szczególnie w Europie i Oceanii, gdzie osiąga wartości przekraczające 25 przypadków na 100 000 mieszkańców. Wysokie wskaźniki dotyczą także grupy wiekowej 55–74 lata, szczególnie w tych samych regionach.
...
Wyniki tej analizy podkreślają konieczność dostosowania polityk prewencyjnych, wsparcia psychologicznego oraz działań edukacyjnych do specyfiki regionalnej, demograficznej i gospodarczej poszczególnych krajów. Przeciwdziałanie samobójstwom wymaga zatem uwzględnienia szerokiego kontekstu społecznego, ekonomicznego i kulturowego.
